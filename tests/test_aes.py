...
from pybacked.handlers.aes import aes_decrypt, aes_encrypt, hash_password, hexlify
...
class TestAES(unittest.TestCase):
    def test_hash_password(self):
        ...
        salt = hexlify(get_random_bytes(16))
    ...
    def test_aes_encrypt_and_decrypt(self):
        ...
        decrypted_data = aes_decrypt(encrypted_data, hash_password(password, salt))
